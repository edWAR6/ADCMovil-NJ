...
public class servicioLocalizacion_MyLocationListener
	extends md53cd8d70d5bfba26724e617fb9dfbb756.servicioLocalizacion
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AndroidAPI22ADCLibrary.Helpers.servicioLocalizacion+MyLocationListener, AndroidAPI22ADCLibrary, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", servicioLocalizacion_MyLocationListener.class, __md_methods);
	}


	public servicioLocalizacion_MyLocationListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == servicioLocalizacion_MyLocationListener.class)
			mono.android.TypeManager.Activate ("AndroidAPI22ADCLibrary.Helpers.servicioLocalizacion+MyLocationListener, AndroidAPI22ADCLibrary, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
