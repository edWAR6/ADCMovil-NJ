...
{
    public class NotificacionesRealizadasConDuracion : Reports.Report
    {
        ...
        public NotificacionesRealizadasConDuracion() : base("Notificaciones realizadas con su respectiva duración")
        {
            input_oficina = null;
            input_despacho = null;
        ...
        public override Fragment getOutputReportFragment()
        {
            ...
            // al segmento para que el mismo puede obtener/retornar de manera simple
            // los parametros
            return new NotificacionesRealizadasConDuracionOutputReport(this);
        }
    }
}