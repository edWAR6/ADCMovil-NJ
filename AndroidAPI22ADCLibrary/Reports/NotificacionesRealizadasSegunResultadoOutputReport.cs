...
{
    public class NotificacionesRealizadasSegunResultadoOutputReport : Fragment
    {
        NotificacionesRealizadasSegunResultado report;

        public NotificacionesRealizadasSegunResultadoOutputReport(NotificacionesRealizadasSegunResultado report)
        {
            this.report = report;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            string query = @"https://pjgestionnotificacionmovilservicios.azurewebsites.net/api/Reportes/NotificacionesDiligencidadasPorResultado" +
